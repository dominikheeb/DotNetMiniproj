...
namespace AutoReservation.Ui.ViewModels
{
    ...
    {
        private readonly List<KundeDto> kundeOrginal = new List<KundeDto>();
        ...
        private KundeDto selctedKunde;
        public KundeDto SelectedKunde
        {
            get { return  selctedKunde; }
            set
            {
                if (selctedKunde == value)
                {
                    return;
                }
                selctedKunde = value;
                this.OnPropertyChanged(p => p.selctedKunde);
            }
        }
        ...
        private void SaveData()
        {
            foreach (var kunde in Kunden)
            {
                ...
                {
                    var original = kundeOrginal.FirstOrDefault(ao => ao.Id == kunde.Id);
